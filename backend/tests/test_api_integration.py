"""
Integration tests for the Krishi Agent backend — MongoDB-based registration flow.
Tests do NOT call Groq/LLM APIs.
...
def clean_db():
    """Clean the farmers collection before and after test module."""
...
class TestOnboardRequest:
    ...
    def test_default_language(self):
        req = OnboardRequest(name="Test", phone="9876543210", district="Nashik", password="Password123!")
