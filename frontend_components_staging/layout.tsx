    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Krishi Agent — multi-agent pipeline for Indian farmers",
      },
    ],
  },
  twitter: {
    ...
    title: "Krishi Agent — Season-long intelligence for every acre",
    description:
      "Soil Health Card + Agmarknet + satellite NDVI + PMFBY — wired into a single LangGraph pipeline that runs an entire farming season.",
    images: ["/og-image.png"],
  },
